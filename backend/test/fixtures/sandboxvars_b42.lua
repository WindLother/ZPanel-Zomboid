SandboxVars = {
    ...
    -- A hypothetical FUTURE vanilla option ZPanel has no schema for.
    SomeFuturePZOption = 42,
    SomeMod = {
        OptionA = true,
        OptionB = 5,
        Nested = {
